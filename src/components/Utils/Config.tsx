...
export const UnitButton = () => {
  ...
  return (
    <div className="relative flex flex-col gap-2 w-full items-end justify-center">
      <div
        className={cn(
          "flex items-center justify-end gap-2 bg-Neutral-700 font-dmSans text-sm text-Neutral-0 px-3 py-2 cursor-pointer rounded-md",
          { "border border-Neutral-0 px-[0.7rem] py-[0.45rem]": open },
        )}
